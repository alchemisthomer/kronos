// Duplicated from ../../salesforce-rest-query-csv/src/auth.ts.
// This is the 5th tool with this file. The tools/_shared/salesforce/ hoist
// is now unambiguously overdue; tracked as follow-up work.
